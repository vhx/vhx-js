...
exports.send = function(data){
  ...
  var obj = isObject_1(data);
  var type = this._header['content-type'];

  // merge
  if (obj && isObject_1(this._data)) {
    for (var key in data) {
...
function request$1(RequestConstructor, method, url) {
  // callback
...
Response.prototype._setHeaderProperties = function(header){
  ...
  // params
  var obj = params(ct);
  for (var key in obj) { this$1[key] = obj[key]; }
};
...
function getMethod(params) {
  return isObject$2(params) && params.method ?
          params.method :
          params;
}
...
var createUrlWithCustomEndpoints = function (params, resource, options) {
  ...
  if (params && isHref(params) && !isFunction(params) && !isObject$2(params)) {
    return params;
  }
